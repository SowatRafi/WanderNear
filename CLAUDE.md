...
- **M3 — Travel Journal** (in progress — J1–J2 done: Room `journal.db`, save from
  chat, My Trips list + detail with editable notes, bucket list (todo/done),
  visit dates (date picker) + delete-confirm; full journal schema defined up
  front to avoid migrations): private "My Trips" — save visited places,
